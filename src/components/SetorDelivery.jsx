...
const SetorDelivery = () => {
  ...
  const servicos = [
    {
      id: 'trafego',
      nome: 'Tráfego Pago Local',
      descricao: 'Campanhas no Instagram e Google focadas no seu raio de entrega',
      icon: TrendingUp,
    ...
    },
    {
      ...
      descricao: 'Cardápio online com fotos profissionais e pedidos pelo WhatsApp',
      icon: Smartphone,
      color: 'from-purple-500 to-pink-500',
    },
    {
      id: 'fotos',
      nome: 'Fotos Profissionais',
      descricao: 'Food styling e fotografia que dão água na boca e vendem mais',
      icon: Camera,
      color: 'from-yellow-500 to-amber-500',
    },
    {
      id: 'avaliacoes',
      nome: 'Gestão de Avaliações',
      descricao: 'Google Meu Negócio e iFood com mais avaliações 5 estrelas',
      icon: Star,
  ...
  const resultados = [
    { numero: '300+', label: 'Pedidos/mês a mais' },
    { numero: '2x', label: 'Ticket médio' },
    { numero: '40%', label: 'Menos dependência iFood' },
    { numero: '5★', label: 'Avaliações' },
  ];
    ...
    <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-6 py-2.5 border-2 border-red-500 text-red-500 rounded-xl font-semibold hover:bg-red-500 hover:text-white transition-all duration-300"
              >
                Quero Mais Pedidos
              </motion.button>
            </div>
            ...
            {isMenuOpen && (
              ...
              >
                ...
                <motion.button
                  onClick={() => scrollToSection('formulario')}
                  whileTap={{ scale: 0.98 }}
                  className="w-full px-6 py-2.5 border-2 border-red-500 text-red-500 rounded-xl font-semibold"
                >
                  Quero Mais Pedidos
                </motion.button>
              </motion.div>
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center pt-20 px-4 overflow-hidden">
        ...
        >
          ...
          >
            <UtensilsCrossed className="text-red-500" size={20} />
            <span className="text-red-500 font-semibold">Setor de Delivery</span>
          </motion.div>
          ...
          >
            Marketing digital para restaurantes, pizzarias, hamburguerias e deliveries.{' '}
            <span className="text-red-500 font-semibold">
              Menos dependência de apps, mais lucro direto
            </span>{' '}
            — pedidos pelo WhatsApp e redes sociais.
          </motion.p>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-red-500 to-orange-500 text-white font-bold px-8 py-4 rounded-xl text-lg flex items-center gap-2 mx-auto sm:mx-0"
            >
              Quero Mais Pedidos
              <ArrowRight size={20} />
            </motion.button>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Estratégias para restaurantes e deliveries venderem mais direto
            </p>
          </motion.div>
            ...
            {servicos.map((servico) => {
              ...
              return (
                <motion.div
                  ...
                  className="glass-card rounded-2xl p-6 border-white/10 hover:border-red-500/50 transition-all duration-300 group cursor-pointer"
                >
      ...
      <section className="py-20 px-4 relative">
        <div className="container mx-auto max-w-4xl">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">
              <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                iFood vs Pedido Direto
              </span>
            </h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-6 rounded-2xl bg-red-500/5 border border-red-500/20">
                <h3 className="text-xl font-bold text-red-400 mb-4">📱 Via iFood</h3>
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-center gap-2">
                    <X className="text-red-500" size={16} />
                    Taxa de até 30% por pedido
                  </li>
                  <li className="flex items-center gap-2">
                    <X className="text-red-500" size={16} />
                    Cliente é do iFood, não seu
                  </li>
                  <li className="flex items-center gap-2">
                    <X className="text-red-500" size={16} />
                  ...
                  <li className="flex items-center gap-2">
                    <X className="text-red-500" size={16} />
                    Sem contato direto com cliente
                  </li>
                </ul>
              </div>
              
              <div className="p-6 rounded-2xl bg-green-500/5 border border-green-500/20">
                <h3 className="text-xl font-bold text-green-400 mb-4">💬 Pedido Direto</h3>
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-center gap-2">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="text-green-500" size={16} />
                    Cliente vira contato no WhatsApp
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="text-green-500" size={16} />
                    Sem concorrência na sua página
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="text-green-500" size={16} />
                    Fidelização e remarketing
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-gray-400 text-lg">
              O que nossos clientes de delivery conquistaram
            </p>
          </motion.div>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-red-500 to-orange-500 text-white font-bold px-8 py-4 rounded-xl flex items-center gap-2"
            >
      ...
      <section id="formulario" className="py-20 px-4 relative min-h-screen flex items-center">
        <div className="container mx-auto max-w-4xl w-full">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-4">
              <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                Vamos Aumentar Seus Pedidos?
              </span>
            </h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Preencha o formulário e receba uma consultoria gratuita para seu delivery
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative glass-strong rounded-3xl p-6 md:p-8 border border-red-500/30 bg-gradient-to-br from-black/40 to-black/60 backdrop-blur-xl shadow-2xl">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Converse com nossa equipe especializada em marketing para delivery
            </p>

            <motion.a
              href="https://wa.me/5571992091220?text=Olá!%20Tenho%20um%20delivery%20e%20gostaria%20de%20saber%20mais%20sobre%20os%20serviços%20da%20BWN"
              target="_blank"
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-6 text-gray-400">
              ...
              <Link to="/saude" className="hover:text-white transition-colors">
                Saúde
              </Link>
            </div>
          </div>
