...
const SetorImobiliario = () => {
  ...
  const servicos = [
    {
      id: 'trafego',
      nome: 'Tráfego Pago Imobiliário',
      descricao: 'Campanhas no Google e Meta focadas em leads qualificados para venda e locação',
      icon: TrendingUp,
    ...
    {
      id: 'crm',
      nome: 'CRM Imobiliário',
      descricao: 'Gestão de leads, follow-up automático e pipeline de vendas organizado',
      icon: Users,
      color: 'from-green-500 to-emerald-500',
    },
    {
      id: 'landing',
      nome: 'Landing Pages de Captação',
      descricao: 'Páginas otimizadas para converter visitantes em leads qualificados',
      icon: Target,
    ...
    },
    {
      ...
      descricao: 'Respostas automáticas 24/7 e agendamento de visitas pelo WhatsApp',
      icon: MessageCircle,
  ...
  const resultados = [
    { numero: '150+', label: 'Leads/mês gerados' },
    { numero: '3x', label: 'Mais visitas agendadas' },
    { numero: '40%', label: 'Redução no custo por lead' },
    { numero: '24h', label: 'Resposta automática' },
  ];
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-6 py-2.5 border-2 border-amber-500 text-amber-500 rounded-xl font-semibold hover:bg-amber-500 hover:text-black transition-all duration-300"
              >
                Quero Mais Leads
              </motion.button>
            </div>
            ...
            {isMenuOpen && (
              ...
              >
                ...
                <motion.button
                  onClick={() => scrollToSection('formulario')}
                  whileTap={{ scale: 0.98 }}
                  className="w-full px-6 py-2.5 border-2 border-amber-500 text-amber-500 rounded-xl font-semibold"
                >
                  Quero Mais Leads
                </motion.button>
              </motion.div>
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center pt-20 px-4 overflow-hidden">
        ...
        >
          ...
          >
            ...
            <span className="text-amber-500 font-semibold">Setor Imobiliário</span>
          </motion.div>
          ...
          >
            Geramos leads qualificados para imobiliárias e corretores na Bahia.{' '}
            <span className="text-amber-500 font-semibold">
              Tráfego pago, CRM, automação e conteúdo
            </span>{' '}
            — tudo integrado para você fechar mais negócios.
          </motion.p>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-amber-500 to-orange-500 text-black font-bold px-8 py-4 rounded-xl text-lg flex items-center gap-2 mx-auto sm:mx-0"
            >
              Quero Mais Leads
              <ArrowRight size={20} />
            </motion.button>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                'Leads frios que não respondem ou não têm perfil',
                'Gasta muito em anúncios mas não vê retorno',
                'Imóveis parados há meses sem interessados',
                'Não consegue acompanhar todos os contatos',
                'Fotos amadoras que não valorizam o imóvel',
                'Concorrência forte nos portais imobiliários',
              ].map((problema, index) => (
                <motion.div
                  key={index}
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Estratégias específicas para imobiliárias e corretores venderem mais
            </p>
          </motion.div>
            ...
            {servicos.map((servico) => {
              ...
              return (
                <motion.div
                  ...
                  className="glass-card rounded-2xl p-6 border-white/10 hover:border-amber-500/50 transition-all duration-300 group cursor-pointer"
                >
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-gray-400 text-lg">
              O que nossos clientes do setor imobiliário conquistaram
            </p>
          </motion.div>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-amber-500 to-orange-500 text-black font-bold px-8 py-4 rounded-xl flex items-center gap-2"
            >
      ...
      <section id="formulario" className="py-20 px-4 relative min-h-screen flex items-center">
        <div className="container mx-auto max-w-4xl w-full">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Preencha o formulário e receba uma consultoria gratuita para sua imobiliária
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative glass-strong rounded-3xl p-6 md:p-8 border border-amber-500/30 bg-gradient-to-br from-black/40 to-black/60 backdrop-blur-xl shadow-2xl">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Converse com nossa equipe especializada em marketing imobiliário
            </p>

            <motion.a
              href="https://wa.me/5571992091220?text=Olá!%20Tenho%20uma%20imobiliária%20e%20gostaria%20de%20saber%20mais%20sobre%20os%20serviços%20da%20BWN"
              target="_blank"
